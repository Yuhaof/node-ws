...
const UUID = process.env.UUID || '6ccbee1e-d913-423f-9cd0-0a4e2344593f'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'smallbudgerigar';            // 获取节点的订阅路径
